$_mod.def("/@feathersjs/tests$4.5.1/lib/client", function(require, exports, module, __filename, __dirname) { "use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
const assert_1 = __importDefault(require('/assert$1.5.0/assert'/*"assert"*/));
    ...
    describe('Service base tests', () => {
        it('.find', () => {
            return getService().find().then((todos) => {
                assert_1.default.deepEqual(todos, [{
                        text: 'some todo',
                        complete: false,
                        id: 0
                    }]);
